abstract class IFlutter3DRepository {
  ...
  /// Fork addition: install min/max clamps on the orbit radius, plus
  /// disable model-viewer's interaction-prompt animation and auto-rotate.
  /// Call once per camera mode entry; use [setCameraOrbit] for per-gesture
  /// updates afterward.
  ...
  /// the arena reads as a proper daytime scene. Call once after the model
  /// loads.
